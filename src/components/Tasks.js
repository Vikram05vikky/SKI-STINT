          ...
          {selectedTask && (
            <div className="task-description">
              ...
              <div className="piththaan">
                <div>
                  <Button className="piththaan4" onClick={handleCloseDialog}>
                    Completed
                  </Button>
                </div>
                <div>
                  <Button className="piththaan3" onClick={handleCloseDialog}>
                    In Progress
                  </Button>
                </div>
                <div>
                  <Button className="piththaan2" onClick={handleCloseDialog}>
                    Yet to Start
                  </Button>
                </div>
              </div>
